...
class KetiInfo extends Migrator
{
    ...
    public function change()
    {
        ...
        $table
            ...
            ->addColumn('subject','integer',['limit'=>11,'null'=>true,'comment'=>'学科分类'])
            ->addColumn('fzdanweiid','integer',['limit'=>11,'null'=>true,'comment'=>'负责单位id'])
            ->addColumn('category','integer',['limit'=>11,'null'=>true,'comment'=>'研究类型'])
            ...
            ->addColumn('jddengji','integer',['limit'=>1,'null'=>false,'default'=>0,'comment'=>'鉴定等级:0=>研究中，1=>合格,2=>优秀,3=>流失'])
