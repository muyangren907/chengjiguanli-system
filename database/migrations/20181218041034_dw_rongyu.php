...
class DwRongyu extends Migrator
{
    ...
    public function change()
    {
        ...
        // 添加当前表字段
        $table
            ->addColumn('project','string',['limit'=>50,'null'=>false,'comment'=>'项目名称'])
            ->addColumn('title','string',['limit'=>50,'null'=>false,'comment'=>'荣誉内容名称'])
            ...
            ->addColumn('url','string',['limit'=>100,'null'=>false,'comment'=>'荣誉图片'])
            ->addColumn('jiangxiang','integer',['limit'=>11,'null'=>false,'comment'=>'奖项'])
            ->addColumn('category','integer',['limit'=>15,'null'=>false,'comment'=>'荣誉类型'])
