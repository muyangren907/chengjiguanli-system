...
class TongjiSch extends Migrator
{
    ...
    public function change()
    {
        ...
        $table
            ...
            ->addColumn('sum','decimal',['precision'=>10,'scale'=>1,'default'=>Null,'null'=>false,'comment'=>'总分'])
            ...
            ->addColumn('jige','decimal',['precision'=>4,'scale'=>1,'default'=>Null,'null'=>false,'comment'=>'及格'])
            ->addColumn('max','decimal',['precision'=>4,'scale'=>1,'default'=>Null,'null'=>false,'comment'=>'最大'])
            ->addColumn('min','decimal',['precision'=>4,'scale'=>1,'default'=>Null,'null'=>false,'comment'=>'最小'])
            ->addColumn('qian','decimal',['precision'=>4,'scale'=>1,'default'=>Null,'null'=>false,'comment'=>'前25%'])
            ->addColumn('zhong','decimal',['precision'=>4,'scale'=>1,'default'=>Null,'null'=>false,'comment'=>'中间%25'])
            ->addColumn('hou','decimal',['precision'=>4,'scale'=>1,'default'=>Null,'null'=>false,'comment'=>'后面25%'])
            ->addColumn('zhongshu','decimal',['precision'=>4,'scale'=>1,'default'=>Null,'null'=>false,'comment'=>'众数'])
