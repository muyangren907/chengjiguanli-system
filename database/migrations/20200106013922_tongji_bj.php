...
class TongjiBj extends Migrator
{
    ...
    public function change()
    {
        ...
        $table
            ...
            ->addColumn('q1','decimal',['precision'=>4,'scale'=>1,'default'=>Null,'null'=>true,'comment'=>'下25%'])
            ->addColumn('q2','decimal',['precision'=>4,'scale'=>1,'default'=>Null,'null'=>true,'comment'=>'中间%25'])
            ->addColumn('q3','decimal',['precision'=>4,'scale'=>1,'default'=>Null,'null'=>true,'comment'=>'上面25%'])
