...
class SystemBase extends Migrator
{
    ...
    public function up()
    {
        ...
        $table
            ...
            ->addColumn('grademax','integer',['limit'=>2,'default'=>'6','null'=>false,'comment'=>'排序'])
            ->addColumn('classmax','integer',['limit'=>2,'default'=>'30','null'=>false,'comment'=>'排序'])
            ->addColumn('classalias','boolean',['limit'=>1,'default'=>0,'null'=>false,'comment'=>'是否开启班级另名'])
