...
class Chengji extends Migrator
{
    ...
    public function change()
    {
        ...
        $table
            ...
            ->addColumn('yuwen','decimal',['precision'=>4,'scale'=>1,'default'=>Null,'null'=>false,'comment'=>'语文'])
            ->addColumn('shuxue','decimal',['precision'=>4,'scale'=>1,'default'=>Null,'null'=>false,'comment'=>'数学'])
            ->addColumn('waiyu','decimal',['precision'=>4,'scale'=>1,'default'=>Null,'null'=>false,'comment'=>'外语'])
