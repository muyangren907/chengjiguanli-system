...
class Chengji extends Migrator
{
    ...
    public function change()
    {
        ...
        $table
            ...
            ->addColumn('subject_id','integer',['limit'=>4,'null'=>false,'comment'=>'学科'])
            ->addColumn('user_id','string',['limit'=>4,'null'=>false,'comment'=>'学生'])
            ->addColumn('defen','decimal',['precision'=>4,'scale'=>1,'default'=>Null,'null'=>false,'comment'=>'得分'])
