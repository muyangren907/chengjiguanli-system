...
class Subject extends Seeder
{
    ...
    public function run()
    {
        ...
        $rows= [
            ...
            ['title'=>'物理','jiancheng'=>'物','category'=>1011006,'lieming'=>'wuli','paixu'=>4],
            ['title'=>'化学','jiancheng'=>'化','category'=>1011006,'lieming'=>'huaxue','paixu'=>5],
            ...
            ['title'=>'科学','jiancheng'=>'科','category'=>1011006,'lieming'=>'kexue','kaoshi'=>false,'paixu'=>10],
            ['title'=>'品德与生活/社会','jiancheng'=>'品','category'=>1011004,'lieming'=>'pinshe','kaoshi'=>false,'paixu'=>11],
