...
class Subject extends Seeder
{
    ...
    public function run()
    {
        // 设置数据
        $rows= [
            ['title'=>'语文','jiancheng'=>'语','category'=>'2011','lieming'=>'yuwen','paixu'=>1],
            ['title'=>'数学','jiancheng'=>'数','category'=>'2012','lieming'=>'shuxue','paixu'=>2],
            ['title'=>'外语','jiancheng'=>'外','category'=>'2013','lieming'=>'waiyu','paixu'=>3],
