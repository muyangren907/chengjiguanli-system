...
## 更新内容
	...
	修改单位获取和计算优秀率、得分率方法
	修改系统默认类别
	增加网页成绩统计项目显示设置(超级管理员)
	增加学科优秀和及格人数、差生率、参与率、全科优秀率、全科优秀人数统计
	增加统计项目设置
	兼容Linux操作系统
	增加基础数据
	修复已知错误
...
## 感谢
这个项目一直在更新和完善，在这个磕磕绊绊的成长过程中得到了许多朋友、同仁的支持和肯定，特别是水月居、哒哒达、洁、王兵hb、不一样、sunz_7、小白和在码云评论区及时反馈问题的朋友们，有了你们的建议和反馈才让这个项目的功能更加完善，同时也感谢留下Watch、Star、Fork的朋友们，不断增加的Star也是让我坚持下去的动力源泉。
