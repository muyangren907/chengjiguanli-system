...
## 升级提示
  v1.3.1升级到v1.3.2版本时，对 cj_chengji 、 cj_tongji_bj 、 cj_tongji_nj 、 cj_tongji_sch 几个做的字段作了调整，具体调整，请参考号 database/migrations 文件下对应的文件，如果已经存在数据的话，建议重新建表并执行结构同步。如果有没数据可以重新建表。
...
## 求助
* 一直想给这个项目起个名字，想了几个都不合适，朋友们能给一个好名字的话兄弟会非常感谢！